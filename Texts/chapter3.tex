...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{0.499\textwidth}
		...
		\end{center}
	\end{subfigure}
	\caption{\image{caption me please}}
	\label{fig:sampleSkeletonDiagrams}
\end{figure}


\begin{itemize}
	\item \todo{By putting an upper bound $ n \leq n_\text{max} $ of the generated diagrams in the Markov process... }
\end{itemize}
...
For simplicity it is used that $ n_\text{max} = 1 $ so that



\noindent \textbf{First iteration}

\begin{fmffile}{FMFFILEfirstIterationSelfEnergy}
    	\begin{empheq}[box={\FDbox[0pt][0pt]}]{equation*}
	    	\Sigma^*_1 =
	    	\begin{tikzpicture}[baseline={([yshift=-.5ex]current bounding box.center)}]
	    		\node {
...
\begin{fmffile}{FMFFILEfirstIterationG}
	\begin{empheq}[box={\FDbox[0pt][0pt]}]{equation}
		\label{eq:BoldG1}
		\begin{split}
			\Gt_1
				...
				\node {
					\FDframe{
						\begin{fmfgraph*}(11, 1)
							\fmfstraight
							\fmfbottom{i,o}
							\fmf{fermion, foreground=(1,,0,,0)}{i,o}
						\end{fmfgraph*}%
					}%
				};
			\end{tikzpicture} \\
...
\noindent During the simulation of $ \Sigma^*_2 $, the propagator $ \Gt_1 $, obtained from the first iteration, is used in favor of the bare $ \Gt^{(0)} $. Hence
\begin{fmffile}{FMFFILEsecondIterationSelfEnergy}
    	\begin{empheq}[box={\FDbox[0pt][0pt]}]{equation*}
	    	\Sigma^*_2 =
	    	\begin{tikzpicture}[baseline={([yshift=-.5ex]current bounding box.center)}]
	    		\node {
    				...
    				\begin{fmfgraph*}(11, 6)
    					\fmfbottom{b1,b2}
    					\fmf{fermion, foreground=(1,,0,,0)}{b1,b2}
    					\fmf{dashes, left}{b1,b2}
    					\fmfdot{b1,b2}
    				\end{fmfgraph*}%
    				}
    	...
    	\end{empheq}
\end{fmffile}%
and according to dyson Dyson equation 
\begin{fmffile}{FMFFILEsecondIterationDyson}
	\begin{empheq}[box={\FDbox[0pt][0pt]}]{equation*}
		\begin{split}
			\Gt_2
			&=
				...
				\node {
					\FDframe{
						\begin{fmfgraph*}(11, 1)					
							\fmfstraight
							\fmfbottom{i,o}
							\fmf{fermion, foreground=(0,,0,,1)}{i,o}
						\end{fmfgraph*}%
					}%
				};
			\end{tikzpicture} \\
				...
				\node {
					\FDframe{
						\begin{fmfgraph*}(33, 5.5)					
							...
							\fmfbottom{i,o}
							\fmf{fermion}{i,v1}
							\fmf{fermion, foreground=(1,,0,,0)}{v1,v2}
							\fmf{fermion}{v2,o}
							\fmf{dashes, left, tension=0}{v1,v2}
							\fmfdot{v1,v2}
						\end{fmfgraph*}%
				...
				\node {
					\FDframe{
						\begin{fmfgraph*}(55, 5.5)
							...
							\fmf{fermion, foreground=(1,,0,,0)}{v1,v2}
 							\fmf{fermion}{v2,v3}
							\fmf{fermion, foreground=(1,,0,,0)}{v3,v4}
							\fmf{fermion}{v4,o}
							\fmf{dashes, left, tension=0}{v1,v2}
							\fmf{dashes, left, tension=0}{v3,v4}
							\fmfdot{v1,v2,v3,v4}
	...
	\end{empheq}
\end{fmffile}%
By substituting with the diagram series for $ \Gt_1 $ (\ref{eq:BoldG1}), $ \Gt_2 $ is expressed entirely out of bare constituents, i.e.  
...
\begin{itemize}
	\item \todo{Diagram with intersecting phonon lines wont appear in this diagram series...}
\end{itemize}
...
\begin{figure}[H]
	\centering
	\begin{subfigure}[b]{\textwidth}
		\includegraphics[width=\textwidth]{{"Images/Plots/bold/S/boldplot_a_S_nmax=1_p=0.01"}.pdf}
	\end{subfigure} \\
	\begin{subfigure}[b]{\textwidth}
		\includegraphics[width=\textwidth]{{"Images/Plots/bold/G/boldplot_a_G_nmax=1_p=0.01"}.pdf}
	\end{subfigure}
...
\begin{figure}[H]
	\centering
	\begin{subfigure}[b]{\textwidth}
		\includegraphics[width=\textwidth]{{"Images/Plots/bold/S/boldplot_a_S_nmax=2_p=0.01"}.pdf}
	\end{subfigure} \\
	\begin{subfigure}[b]{\textwidth}
		\includegraphics[width=\textwidth]{{"Images/Plots/bold/G/boldplot_a_G_nmax=2_p=0.01"}.pdf}
	\end{subfigure}
	\caption{\image{caption me plx}}
	\label{fig:??}
\end{figure}
...
\begin{figure}[H]
	\centering
	\begin{subfigure}[b]{\textwidth}
		\includegraphics[width=\textwidth]{{"Images/Plots/bold/S/boldplot_a_S_nmax=3_p=0.01"}.pdf}
	\end{subfigure} \\
	\begin{subfigure}[b]{\textwidth}
		\includegraphics[width=\textwidth]{{"Images/Plots/bold/G/boldplot_a_G_nmax=3_p=0.01"}.pdf}
	\end{subfigure}
	\caption{\image{caption me plx}}
	\label{fig:??}
\end{figure}
...
\begin{figure}[H]
	\centering
	\begin{subfigure}[b]{\textwidth}
		\includegraphics[width=\textwidth]{{"Images/Plots/bold/S/boldplot_a_S_nmax=4_p=0.01"}.pdf}
	\end{subfigure} \\
	\begin{subfigure}[b]{\textwidth}
		\includegraphics[width=\textwidth]{{"Images/Plots/bold/G/boldplot_a_G_nmax=4_p=0.01"}.pdf}
	\end{subfigure}
	\caption{\image{caption me plx}}
	\label{fig:??}
\end{figure}
...
\begin{figure}[H]
	\centering
	\begin{subfigure}[b]{\textwidth}
		\includegraphics[width=\textwidth]{{"Images/Plots/bold/S/boldplot_a_S_nmax=5_p=0.01"}.pdf}
	\end{subfigure} \\
	\begin{subfigure}[b]{\textwidth}
		\includegraphics[width=\textwidth]{{"Images/Plots/bold/G/boldplot_a_G_nmax=5_p=0.01"}.pdf}
	\end{subfigure}
	\caption{\image{caption me plx}}
	\label{fig:??}
\end{figure}
...
\begin{figure}[H]
	\centering
	\begin{subfigure}[b]{\textwidth}
		\includegraphics[width=\textwidth]{{"Images/Plots/bold/S/boldplot_a_S_nmax=6_p=0.01"}.pdf}
	\end{subfigure} \\
	\begin{subfigure}[b]{\textwidth}
		\includegraphics[width=\textwidth]{{"Images/Plots/bold/G/boldplot_a_G_nmax=6_p=0.01"}.pdf}
	\end{subfigure}
	\caption{\image{caption me plx}}
	\label{fig:??}
\end{figure}
...
\begin{figure}[H]
	\centering
	\begin{subfigure}[b]{\textwidth}
		\includegraphics[width=\textwidth]{{"Images/Plots/bold/S/boldplot_a_S_nmax=7_p=0.01"}.pdf}
	\end{subfigure} \\
	\begin{subfigure}[b]{\textwidth}
		\includegraphics[width=\textwidth]{{"Images/Plots/bold/G/boldplot_a_G_nmax=7_p=0.01"}.pdf}
	\end{subfigure}
	\caption{\image{caption me plx}}
	\label{fig:??}
\end{figure}
...
\begin{figure}[H]
	\centering
	\begin{subfigure}[b]{\textwidth}
		\includegraphics[width=\textwidth]{{"Images/Plots/bold/S/boldplot_a_S_nmax=8_p=0.01"}.pdf}
	\end{subfigure} \\
	\begin{subfigure}[b]{\textwidth}
		\includegraphics[width=\textwidth]{{"Images/Plots/bold/G/boldplot_a_G_nmax=8_p=0.01"}.pdf}
	\end{subfigure}
	\caption{\image{caption me plx}}
	\label{fig:??}
\end{figure}
...
\begin{figure}[H]
	\centering
	\begin{subfigure}[b]{\textwidth}
		\includegraphics[width=\textwidth]{{"Images/Plots/bold/S/boldplot_a_S_nmax=9_p=0.01"}.pdf}
	\end{subfigure} \\
	\begin{subfigure}[b]{\textwidth}
		\includegraphics[width=\textwidth]{{"Images/Plots/bold/G/boldplot_a_G_nmax=9_p=0.01"}.pdf}
	\end{subfigure}
	\caption{\image{caption me plx}}
	\label{fig:??}
\end{figure}
