...
\todo{Throughout this text $ \hbar = 1 $ has been used.}
...
\begin{figure}[H]
        ...
        \begin{subfigure}[b]{0.45\textwidth}
                \includegraphics[width=\textwidth]{{"Images/Crystal illustration/before"}.pdf}
        \end{subfigure}\hfill
        \begin{subfigure}[b]{0.45\textwidth}
                \includegraphics[width=\textwidth]{{"Images/Crystal illustration/first"}.pdf}
        \end{subfigure}
        
        \begin{subfigure}[b]{0.45\textwidth}
                \includegraphics[width=\textwidth]{{"Images/Crystal illustration/second"}.pdf}
        \end{subfigure}
        \caption{\image{Illustration of the lattice and the two types of deformation. In the two images with polarisation, depict the cumulative polarisation as well. Also there should be subcaptions!}}
\end{figure}
